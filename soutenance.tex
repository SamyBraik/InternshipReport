...
\begin{frame}{Goal and strategy}
  \begin{itemize}
    ...
    \item \textbf{Strategy:} parameterize coefficients (angles, phases, amplitudes) as learnable parameters (\texttt{nn.Parameter} in PyTorch) and optimize a loss using the following optimizer.
  \end{itemize}
\end{frame}
...
\begin{frame}{Angles}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{Angles/VelIncr4.1.png}
    \includegraphics[width=0.45\textwidth]{Angles/VelIncr4.2.png}
...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{Angles/EnerSpect.png}
